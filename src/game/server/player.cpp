...
static ConVar sv_clockcorrection_msecs( "sv_clockcorrection_msecs", "62.5", 0, "The server tries to keep each player's m_nTickBase withing this many msecs of the server absolute tickcount" );
