...
#ifdef TF2_OG
#define TF_DAMAGE_CRITMOD_DAMAGE			1600
#define TF_DAMAGE_CRITMOD_DAMAGE_MELEE		1600
#else
...
#define TF_DAMAGE_CRITMOD_MAXMULT_MELEE		4
#else
...
#endif
#ifdef TF2_OG
#define TF_REGEN_BOOST			3 			// Multiplier for health regenerated each regen when out of combat.
#else
#define TF_REGEN_BOOST			2 			// Multiplier for health regenerated each regen when out of combat.
#endif
