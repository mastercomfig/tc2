...
static bool BIgnoreIfNotOfficialServer(void)
{
#ifdef GAME_DLL
	return V_strcmp( GameCoordinator_GetRegistrationString(), "Status 'Gordon'" ) != 0;
#else
	return true;
#endif
}
...
convar_tags_t convars_to_check_for_tags[] =
{
	...
	{ "sv_registration_successful", "official", &BIgnoreIfNotOfficialServer },
